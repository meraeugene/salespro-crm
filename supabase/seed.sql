...
values
  ('20000000-0000-4000-8000-000000000001', 'David Wong', 'Stellar Dynamics', '10000000-0000-4000-8000-000000000001', 'david@stellar.example', '+63 917 123 4501', 'Qualified', 'Webinar', (select id from public.profiles where email = 'manager@salespro.test'), '2026-05-18', 'Interested in enterprise rollout.', (select id from public.profiles where email = 'manager@salespro.test'), '2026-04-13'),
  ('20000000-0000-4000-8000-000000000002', 'Benjamin Ross', 'Acme Inc.', '10000000-0000-4000-8000-000000000002', 'ben@acme.example', '+63 917 123 4502', 'Contacted', 'Referral', (select id from public.profiles where email = 'manager@salespro.test'), '2026-05-15', 'Needs procurement review.', (select id from public.profiles where email = 'manager@salespro.test'), '2026-04-18'),
  ('20000000-0000-4000-8000-000000000003', 'Grace Anderson', 'Globax Corporation', '10000000-0000-4000-8000-000000000003', 'grace@globax.example', '+63 917 123 4503', 'Proposal', 'LinkedIn', (select id from public.profiles where email = 'manager@salespro.test'), '2026-05-19', 'Proposal sent for 120 seats.', (select id from public.profiles where email = 'manager@salespro.test'), '2026-04-21'),
...
values
  ...
  ('40000000-0000-4000-8000-000000000005', 'Stellar Expansion', 'Stellar Dynamics', '10000000-0000-4000-8000-000000000001', 59000, 10, 'New Lead', (select id from public.profiles where email = 'manager@salespro.test'), '2026-05-20', (select id from public.profiles where email = 'manager@salespro.test'), '2026-05-02'),
  ('40000000-0000-4000-8000-000000000006', 'Globax Legacy Migration', 'Globax Corporation', '10000000-0000-4000-8000-000000000003', 41000, 60, 'Proposal Sent', (select id from public.profiles where email = 'manager@salespro.test'), '2026-05-12', (select id from public.profiles where email = 'manager@salespro.test'), '2026-05-10')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  company_id = excluded.company_id,
...
values
  ...
  ('70000000-0000-4000-8000-000000000003', 'Deal moved to Proposal Sent', 'deal', '40000000-0000-4000-8000-000000000006', '{"stage":"Proposal Sent","title":"Globax Legacy Migration","company":"Globax Corporation","value":41000,"probability":0}', (select id from public.profiles where email = 'manager@salespro.test'), '2026-05-23'),
